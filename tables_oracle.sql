...
-- CODE TABLE V2
-- DROP TABLE BK_COM_CD_V2 CASCADE CONSTRAINTS;
CREATE TABLE BK_COM_CD_V2
(
    CODE_CD VARCHAR2(50) -- 코드
    , PAR_CODE_CD VARCHAR2(50)  -- 코드시컨스
    , CODE_NM VARCHAR2(40)        -- 코드명
    ...
    , CONSTRAINT BK_COM_CD_V2_PK PRIMARY KEY (CODE_CD)
    , CONSTRAINT  BK_COM_CD_V2_UK UNIQUE (CODE_CD, PAR_CODE_CD)
    , CONSTRAINT BK_COM_CD_V2_FK FOREIGN KEY (PAR_CODE_CD) REFERENCES BK_COM_CD_V2(CODE_CD)

);
COMMENT ON TABLE BK_COM_CD_V2 IS '공통코드';
COMMENT ON COLUMN BK_COM_CD_V2.CODE_CD IS '코드';
COMMENT ON COLUMN BK_COM_CD_V2.PAR_CODE_CD IS '상위코드';
COMMENT ON COLUMN BK_COM_CD_V2.CODE_NM IS '코드명';
COMMENT ON COLUMN BK_COM_CD_V2.CODE_DESC IS '코드설명';
COMMENT ON COLUMN BK_COM_CD_V2.USE_YN IS '사용여부';
COMMENT ON COLUMN BK_COM_CD_V2.REG_DT IS '등록일';
COMMENT ON COLUMN BK_COM_CD_V2.REG_ID IS '등록자';
COMMENT ON COLUMN BK_COM_CD_V2.MOD_DT IS '수정일';
COMMENT ON COLUMN BK_COM_CD_V2.MOD_ID IS '수정자';
