create FUNCTION uf_datetime2string(dt_ IN DATE)
    RETURN VARCHAR2
        IS
           ti NUMBER;
ret_
...
create FUNCTION getColor4Alert(TSSTARTDATE_ IN VARCHAR2
...
create FUNCTION makeCalendar(startdate IN VARCHAR2, enddate IN VARCHAR2)
    RETURN VARCHAR2
        IS
